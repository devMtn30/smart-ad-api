...
class NaverCampaignController(
    ...
    fun getCampaignsByIds(
        ...
        // 2) apiInfoId에 해당하는 NaverApiInfo 찾기
        ...
        val campaignList: List<Campaign> = naverAdApiService.fetchCampaigns(targetApiInfo, emptyList()) ?: emptyList()
